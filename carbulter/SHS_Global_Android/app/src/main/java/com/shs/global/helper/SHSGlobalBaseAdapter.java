 ...
 */
public abstract class SHSGlobalBaseAdapter<T, H extends SHSGlobalBaseAdapterHelper>
		extends BaseAdapter {

	protected static final String TAG = SHSGlobalBaseAdapter.class
			.getSimpleName();
	 ...
	 */
	public SHSGlobalBaseAdapter(Context context, int layoutResId) {
	 ...
	 */
	public SHSGlobalBaseAdapter(Context context, int layoutResId, List<T> data) {
	...
	public SHSGlobalBaseAdapter(Context context, List<T> data,
